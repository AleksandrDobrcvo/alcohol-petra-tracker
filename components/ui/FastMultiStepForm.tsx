...
import { Send, Beer, Sprout, Coins, Calendar, User, Package, X, Check, ChevronLeft, ChevronRight } from "lucide-react";
...
interface FastMultiStepFormProps {
  onSubmit: (data: FormData) => Promise<void>;
  onClose: () => void;
}

export default function FastMultiStepForm({ onSubmit, onClose }: FastMultiStepFormProps) {
  ...
  if (showSuccess) {
    return (
      <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
        <div className="bg-gradient-to-br from-green-600 to-emerald-700 p-8 rounded-2xl text-center max-w-md mx-4">
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 p-8 rounded-3xl max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-zinc-700 shadow-2xl">
        {/* Progress Bar */}
        <div className="mb-8">
